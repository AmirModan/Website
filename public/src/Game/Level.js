class Level extends Phaser.Scene {
    ...
    preload() {
      this.load.image('Dwayne', '/src/Game/Resources/Images/Enemy.png');
      this.load.image('Platform', '/src/Game/Resources/Images/Platform.png');
      this.load.image('RainDrop', '/src/Game/Resources/Images/Raindrop.png');
      this.load.spritesheet('Asad', '/src/Game/Resources/Images/Player.png', {frameWidth: 197, frameHeight: 154});
